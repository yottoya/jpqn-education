...
export const metadata: Metadata = {
  title: `Privacy Policy - ${BusinessInfo.siteTitle}`,
  description: `Privacy Policy for ${BusinessInfo.siteTitle} services and website.`,
};
    ...
    <main className="min-h-screen py-24 px-4 md:px-8 max-w-4xl mx-auto mt-16">
      ...
      <div className="space-y-6 text-lg text-muted-foreground">
        ...
        <section>
          ...
          <p>
            Welcome to {BusinessInfo.siteTitle} (&quot;we,&quot;
        ...
        <section>
          ...
          <p className="mb-2">
            ...
            services, or otherwise contacting us. The personal information that
            we collect depends on the context of your interactions with us, the
            choices you make, and the services you use. The personal information
        ...
        <section>
          ...
          <p className="mb-2">
            ...
            of educational and business purposes described below. We process
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              To communicate with parents and students regarding progress,
        ...
        <section>
          ...
          <p>
            ...
            business obligations. We do not sell, rent, or trade your personal
        ...
        <section>
          ...
          <p>
            ...
            organizational and technical security measures. However, please also
