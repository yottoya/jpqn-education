...
import classPhoto from "../public/julias-class.jpg";
  ...
  return (
    <>
      <main className="">
        ...
        <section
          id="hero"
          className="mt-28 relative w-full aspect-[16/9] md:aspect-[21/9] bg-cover bg-center flex items-center justify-center"
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
            ...
            <button className="bg-primary text-white px-8 py-4 rounded-lg font-semibold shadow-lg hover:bg-primary/90 transition-colors">
        ...
        {/* Solution Section */}
        <section id="solution" className="py-16 px-4 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-8">
        ...
        <section id="vision" className="py-16 px-4 bg-gray-50">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed mb-8">
              ...
              background, is equipped to succeed on their own terms. My vision
              is a world where education inspires not just performance, but
              purpose.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="mb-4">
                    For children with autism and other learning differences in
