    ...
    <section id="policy" className="py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg leading-relaxed">
          ...
          scheduled session will incur a $40 cancellation fee. Payments are due
          at the end of each session. Full payments for the week are accepted,
          and any unused amounts will be credited.
        </p>
      </div>
    </section>
  );
